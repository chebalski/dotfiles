...
alias ll="ls -hltF ${colorflag}"

# List all files colorized in long format, including dot files
alias la="ls -haltF ${colorflag}"

# List only directories
alias lsd="ls -ltF ${colorflag} | grep --color=never '^d'"
...
# prompt before overwriting copy/move
alias cp='cp -i'
alias mv='mv -i'
...
alias dldl='docker logs $(dl)'
alias dpa="docker ps -a" # Get containers including stoppped ones
alias dps="docker ps" # Get container processes
